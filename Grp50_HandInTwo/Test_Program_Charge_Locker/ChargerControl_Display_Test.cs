...
namespace Test_Program_Charge_Locker
{
    ...
    class ChargerControl_Display_Test
    {
        ...
        //{
        //    //Arrange
        //    usbCharger.CurrentValueEvent += Raise.EventWith((new CurrentEventArgs()));
        //    Assert.That(uut.Connected, Is.EqualTo(Called));
        ...
        [TestCase(false)]
        public void Charging_WhenNewEvetIsFiredDisplayIsCalled_DisplayMethodChargingIsCalled(bool isCalled)
        {
            //Arrange
            usbCharger.CurrentValueEvent += Raise.EventWith((new CurrentEventArgs()));
            Assert.That(uut.Connected, Is.EqualTo(isCalled));
